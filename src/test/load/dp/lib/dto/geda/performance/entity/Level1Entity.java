 ...
 */
@Ignore
public class Level1Entity implements Verifiable, Level1<Level2Entity> {
	...
	private List<Level2Entity> collection1;
	private List<Level2Entity> collection2;
	private List<Level2Entity> collection3;
	private List<Level2Entity> collection4;
	private List<Level2Entity> collection5;
	...
	public Level1Entity(
			...
			List<Level2Entity> collection1, List<Level2Entity> collection2, List<Level2Entity> collection3, 
			List<Level2Entity> collection4, List<Level2Entity> collection5)
	{
		super();
	...
	public List<Level2Entity> getCollection1() {
		return collection1;
	}

	
	public void setCollection1(List<Level2Entity> collection1) {
		this.collection1 = collection1;
	}

	
	public List<Level2Entity> getCollection2() {
		return collection2;
	}

	
	public void setCollection2(List<Level2Entity> collection2) {
		this.collection2 = collection2;
	}

	
	public List<Level2Entity> getCollection3() {
		return collection3;
	}

	
	public void setCollection3(List<Level2Entity> collection3) {
		this.collection3 = collection3;
	}

	
	public List<Level2Entity> getCollection4() {
		return collection4;
	}

	
	public void setCollection4(List<Level2Entity> collection4) {
		this.collection4 = collection4;
	}

	
	public List<Level2Entity> getCollection5() {
		return collection5;
	}

	
	public void setCollection5(List<Level2Entity> collection5) {
		this.collection5 = collection5;
	}
