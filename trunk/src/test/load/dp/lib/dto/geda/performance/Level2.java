 ...
 * @author DPavlov
 */
public interface Level2 extends Verifiable {
	...
	void setEntity1(Level3 entity1);

	Level3 getEntity2();

	void setEntity2(Level3 entity2);

	Level3 getEntity3();

	void setEntity3(Level3 entity3);

	Level3 getEntity4();

	void setEntity4(Level3 entity4);

	Level3 getEntity5();

	void setEntity5(Level3 entity5);
