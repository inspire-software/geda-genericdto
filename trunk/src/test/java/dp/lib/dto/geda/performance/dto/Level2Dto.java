...
public class Level2Dto
{
	...
	private Level3Dto entity1;
	@DtoField(dtoBeanKey = "lvl3")
	private Level3Dto entity2;
	@DtoField(dtoBeanKey = "lvl3")
	private Level3Dto entity3;
	@DtoField(dtoBeanKey = "lvl3")
	private Level3Dto entity4;
	@DtoField(dtoBeanKey = "lvl3")
	private Level3Dto entity5;
	...
	public Level3Dto getEntity1() {
		return entity1;
	}

	
	public void setEntity1(Level3Dto entity1) {
		this.entity1 = entity1;
	}

	
	public Level3Dto getEntity2() {
		return entity2;
	}

	
	public void setEntity2(Level3Dto entity2) {
		this.entity2 = entity2;
	}

	
	public Level3Dto getEntity3() {
		return entity3;
	}

	
	public void setEntity3(Level3Dto entity3) {
		this.entity3 = entity3;
	}

	
	public Level3Dto getEntity4() {
		return entity4;
	}

	
	public void setEntity4(Level3Dto entity4) {
		this.entity4 = entity4;
	}

	
	public Level3Dto getEntity5() {
		return entity5;
	}

	
	public void setEntity5(Level3Dto entity5) {
