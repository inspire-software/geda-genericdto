...
interface Pipe {
     ...
     * 
	 * @throws AnnotationMissingException missing {@link dp.lib.dto.geda.annotations.Dto} in sub DTO's
	 ...
	 * @throws ValueConverterNotFoundException if value converter is not found in #converters map
	 * @throws NotValueConverterException  if converter under given key is not a valid converter
	 * @throws AnnotationMissingException when sub DTO is missing {@link dp.lib.dto.geda.annotations.Dto}
