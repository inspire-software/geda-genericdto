 ...
 * Time: 9:34 AM
 */
public class MyEntityWithSameFieldsClass implements MyEntityWithSameFieldsInterface {
    ...
    private String wrongNameOnEntity;
    ...
    public String getWrongNameOnEntity() {
        return wrongNameOnEntity;
    }

    public void setWrongNameOnEntity(final String wrongNameOnEntity) {
        this.wrongNameOnEntity = wrongNameOnEntity;
    }

    public Double getWrongType() {
        return wrongType;
    }

    public void setWrongType(final Double wrongType) {
