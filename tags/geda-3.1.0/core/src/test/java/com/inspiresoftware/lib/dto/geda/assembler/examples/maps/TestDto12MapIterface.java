 ...
 */
@Ignore
public interface TestDto12MapIterface {
	
	/**
	 * @return items of collection
	 */
	Map<String, TestDto12CollectionItemIterface> getItems();
	/**
	 * @param items items of collection
	 */
	void setItems(Map<String, TestDto12CollectionItemIterface> items);
